...
void (* const g_pfnVectors[])(void) = {
   ...
   GPIO0_IRQHandler,      /* 0x30 0x000000C0 - No Handler set for ISR GPIO0 (IRQ 32) */
   GPIO1_IRQHandler,      /* 0x31 0x000000C4 - No Handler set for ISR GPIO1 (IRQ 33) */
   GPIO2_IRQHandler,      /* 0x32 0x000000C8 - No Handler set for ISR GPIO2 (IRQ 34) */
   GPIO3_IRQHandler,      /* 0x33 0x000000CC - No Handler set for ISR GPIO3 (IRQ 35) */
   GPIO4_IRQHandler,      /* 0x34 0x000000D0 - No Handler set for ISR GPIO4 (IRQ 36) */
   GPIO5_IRQHandler,      /* 0x35 0x000000D4 - No Handler set for ISR GPIO5 (IRQ 37) */
   GPIO6_IRQHandler,      /* 0x36 0x000000D8 - No Handler set for ISR GPIO6 (IRQ 38) */
   GPIO7_IRQHandler,      /* 0x37 0x000000DC - No Handler set for ISR GPIO7 (IRQ 39) */
